...
// -------------------- removing naviagtion to the drive
...
const DriveItem = ({
  ...
  if (view === "list") {
    return (
      <button
        onClick={handleClick}
        className={`group w-full flex items-center gap-4 px-4 py-3 rounded-xl transition-all text-left border ${
          selected
  ...
  return (
    <button
      onClick={handleClick}
      className={`group relative flex flex-col gap-2.5 p-4 rounded-xl transition-all text-left border ${
        selected
